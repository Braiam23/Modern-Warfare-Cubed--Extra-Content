...
public class AUGaction extends ModelWithAttachments {
	...
	public AUGaction() {
		...
		action_r1.cubeList.add(new ModelBox(action_r1, 22, 22, 1.4F, -21.825F, -15.1F, 1, 1, 1, -0.2F, false));
		action_r1.cubeList.add(new ModelBox(action_r1, 77, 12, 1.55F, -24.425F, -16.25F, 1, 2, 2, -0.001F, false));
		...
		action_r3.cubeList.add(new ModelBox(action_r3, 20, 75, -1.0F, 2.575F, -0.15F, 1, 2, 2, 0.0F, false));
