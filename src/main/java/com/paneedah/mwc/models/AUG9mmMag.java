...
public class AUG9mmMag extends ModelWithAttachments {
	...
	public AUG9mmMag() {
		...
		mag5_r1.cubeList.add(new ModelBox(mag5_r1, 88, 80, -2.6F, -12.1F, 11.4F, 1, 1, 5, 0.0F, false));
		...
		mag3_r1.cubeList.add(new ModelBox(mag3_r1, 18, 60, -2.0F, -26.1F, 11.3F, 1, 15, 1, 0.0F, false));
		mag3_r1.cubeList.add(new ModelBox(mag3_r1, 50, 27, -2.5F, -26.1F, 15.5F, 2, 15, 1, 0.0F, false));
		mag3_r1.cubeList.add(new ModelBox(mag3_r1, 88, 60, -2.5F, -26.1F, 11.5F, 2, 15, 4, 0.0F, false));
	}
