...
public class MakarovMag extends ModelWithAttachments {
	...
	public MakarovMag() {
		...
		Mag.setRotationPoint(-1.5767F, -2.4483F, -0.9229F);
		setRotationAngle(Mag, 2.8449F, 0.0F, 3.1416F);
		Mag.cubeList.add(new ModelBox(Mag, 25, 17, -1.9233F, 6.1632F, 1.219F, 3, 1, 1, 0.0F, false));
		Mag.cubeList.add(new ModelBox(Mag, 4, 48, 0.6767F, 6.1632F, 1.219F, 1, 1, 1, 0.0F, false));
		Mag.cubeList.add(new ModelBox(Mag, 93, 52, -1.6233F, -6.8368F, -3.281F, 3, 1, 4, 0.0F, false));
		Mag.cubeList.add(new ModelBox(Mag, 36, 49, 0.6767F, -6.9368F, -1.481F, 1, 2, 3, 0.0F, false));
		Mag.cubeList.add(new ModelBox(Mag, 33, 112, -1.896F, -6.9563F, -1.4615F, 3, 2, 3, 0.0F, false));

		gun23_r1 = new ModelRenderer(this);
		gun23_r1.setRotationPoint(1.3767F, 22.4794F, 10.2169F);
		...
		gun21_r1.setRotationPoint(1.3767F, 23.1349F, 8.3639F);
		...
		gun19_r1.setRotationPoint(1.3767F, 22.4819F, 10.1947F);
		...
		gun15_r1.setRotationPoint(1.3767F, 22.7792F, 10.34F);
		...
		gun14_r1.setRotationPoint(1.3767F, 22.7792F, 10.3596F);
		...
		gun10_r1.setRotationPoint(1.3767F, 21.2726F, 12.3501F);
		...
		gun5_r1.setRotationPoint(1.3767F, 22.3713F, 10.1823F);
		...
		gun1_r1.setRotationPoint(1.3767F, 24.3983F, 7.275F);
