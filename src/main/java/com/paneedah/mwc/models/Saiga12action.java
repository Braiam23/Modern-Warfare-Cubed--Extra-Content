...
public class Saiga12action extends ModelWithAttachments {
	...
	public Saiga12action() {
		...
		action.cubeList.add(new ModelBox(action, 34, 66, -0.6F, 0.0035F, -5.9995F, 1, 1, 4, 0.0F, false));
		action.cubeList.add(new ModelBox(action, 12, 42, -2.9F, 0.0035F, -5.4995F, 3, 1, 1, 0.0F, false));
		...
		action7_r1.cubeList.add(new ModelBox(action7_r1, 31, 25, -3.7F, -37.0F, -29.5F, 1, 1, 1, 0.0F, false));
		...
		action5_r1.cubeList.add(new ModelBox(action5_r1, 80, 34, -2.7F, -39.2F, -26.5F, 1, 2, 6, 0.0F, false));
		...
		action4_r1.cubeList.add(new ModelBox(action4_r1, 53, 63, -3.6F, -37.0F, -26.5F, 1, 1, 7, 0.0F, false));
		...
		action3_r1.cubeList.add(new ModelBox(action3_r1, 0, 158, -3.5F, -37.0F, -33.5F, 2, 1, 15, 0.0F, false));
		...
		action1_r1.cubeList.add(new ModelBox(action1_r1, 23, 25, -2.6F, -39.2F, -33.5F, 1, 2, 13, 0.0F, false));
		...
		action9_r1.cubeList.add(new ModelBox(action9_r1, 14, 44, -4.7F, -37.0F, -33.0F, 2, 1, 1, 0.0F, false));
	}
