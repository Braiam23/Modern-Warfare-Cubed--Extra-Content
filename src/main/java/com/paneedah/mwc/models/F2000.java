...
public class F2000 extends ModelWithAttachments {
	...
	private final ModelRenderer bottons;
	...
	public F2000() {
		...
		gun.setRotationPoint(0.0354F, -1.9322F, -1.9816F);
		...
		bottons = new ModelRenderer(this);
		bottons.setRotationPoint(-0.0354F, 25.9322F, 1.9816F);
		gun.addChild(bottons);
		bottons.cubeList.add(new ModelBox(bottons, 84, 57, 1.43F, -33.2997F, 2.0559F, 1, 1, 1, 0.0F, false));
		bottons.cubeList.add(new ModelBox(bottons, 92, 62, -2.93F, -33.537F, 0.0804F, 2, 2, 2, -0.5F, false));

		cube_r1_r1 = new ModelRenderer(this);
		cube_r1_r1.setRotationPoint(0.0F, 5.7351F, 19.653F);
		bottons.addChild(cube_r1_r1);
		setRotationAngle(cube_r1_r1, 0.7418F, 0.0F, 0.0F);
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 88, 57, 1.1F, -29.7F, 21.2F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 87, 75, 1.1F, -14.3F, 23.0F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 86, 35, 0.75F, -44.4F, -0.7F, 1, 1, 1, -0.2F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 33, 79, 0.65F, -41.7F, 7.4F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 79, 22, 0.65F, -31.9F, 5.7F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 79, 9, 0.75F, -44.4F, -0.7F, 1, 1, 1, -0.2F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 27, 78, 1.1F, -22.3F, 16.7F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 7, 73, 1.1F, -14.3F, 23.0F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 0, 73, 1.43F, -54.1F, -2.3F, 1, 1, 1, -0.15F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 86, 41, 0.65F, -41.7F, 7.4F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 72, 41, -2.43F, -54.1F, -2.3F, 1, 1, 1, -0.15F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 72, 9, -1.75F, -44.4F, -0.7F, 1, 1, 1, -0.2F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 72, 3, -1.65F, -41.7F, 7.4F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 42, 63, -2.1F, -22.3F, 16.7F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 58, 54, -2.1F, -14.3F, 23.0F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 25, 50, -1.65F, -31.9F, 5.7F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 86, 17, 1.43F, -54.1F, -2.3F, 1, 1, 1, -0.15F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 86, 85, 0.65F, -31.9F, 5.7F, 1, 1, 1, -0.1F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 86, 88, 1.1F, -22.3F, 16.7F, 1, 1, 1, -0.1F, false));

		cube_r2_r1 = new ModelRenderer(this);
		cube_r2_r1.setRotationPoint(0.0F, 7.4241F, 20.3099F);
		bottons.addChild(cube_r2_r1);
		setRotationAngle(cube_r2_r1, 0.7418F, 0.0F, 0.0F);
		cube_r2_r1.cubeList.add(new ModelBox(cube_r2_r1, 0, 79, 1.43F, -39.3F, 16.4F, 1, 1, 1, -0.15F, false));
		cube_r2_r1.cubeList.add(new ModelBox(cube_r2_r1, 86, 3, 1.43F, -39.3F, 16.4F, 1, 1, 1, -0.15F, false));
		cube_r2_r1.cubeList.add(new ModelBox(cube_r2_r1, 54, 63, -2.43F, -39.3F, 16.4F, 1, 1, 1, -0.15F, false));

		cube_r3_r1 = new ModelRenderer(this);
		cube_r3_r1.setRotationPoint(9.062F, -0.7312F, 0.0F);
		bottons.addChild(cube_r3_r1);
		setRotationAngle(cube_r3_r1, 0.0F, 0.0F, -0.2793F);
		cube_r3_r1.cubeList.add(new ModelBox(cube_r3_r1, 85, 48, 1.43F, -32.4997F, 2.0559F, 1, 1, 1, 0.0F, false));

		handguard = new ModelRenderer(this);
		handguard.setRotationPoint(0.0F, 24.1415F, 0.0773F);
		...
		cube_r4.setRotationPoint(2.1F, -22.5415F, 17.1227F);
		handguard.addChild(cube_r4);
		setRotationAngle(cube_r4, 0.7418F, 0.0F, 0.0F);
		cube_r4.cubeList.add(new ModelBox(cube_r4, 7, 79, -0.95F, -26.0F, -22.1F, 1, 1, 1, -0.2F, false));
		cube_r4.cubeList.add(new ModelBox(cube_r4, 79, 3, -0.95F, -32.0F, -29.1F, 1, 1, 1, -0.2F, false));
		cube_r4.cubeList.add(new ModelBox(cube_r4, 72, 35, -4.25F, -32.0F, -29.1F, 1, 1, 1, -0.2F, false));
		cube_r4.cubeList.add(new ModelBox(cube_r4, 72, 22, -4.3F, -28.0F, -24.6F, 1, 1, 1, -0.2F, false));
