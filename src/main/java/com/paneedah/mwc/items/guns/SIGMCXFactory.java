	...
	public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.SIGMCXHandguard, true, (model) -> {
            if(model instanceof AKRail) {
            	GL11.glTranslatef(-0.22F, -1.6F, -5.5f);
                GL11.glScaled(0.7F, 0.7F, 0.85F);
          } else if(model instanceof AKRail2) {
              GL11.glTranslatef(-0.42F, -1F, -4.3F);
              GL11.glScaled(0.7F, 0.7F, 0.7F);
              GL11.glRotatef(-90F, 0f, 0f, 1f);
          } else if(model instanceof AKRail3) {
              GL11.glTranslatef(-0.025F, -0.72F, -4.5F);
              GL11.glScaled(0.7F, 0.7F, 0.85F);
        ...
        .withCompatibleAttachment(Attachments.SIGMCXHandguardShort, (model) -> {
        	if(model instanceof AKRail) {
            	GL11.glTranslatef(-0.22F, -1.6F, -4.6f);
                GL11.glScaled(0.7F, 0.7F, 0.85F);
          } else if(model instanceof AKRail2) {
              GL11.glTranslatef(-0.42F, -1F, -4.3F);
              GL11.glScaled(0.7F, 0.7F, 0.7F);
		...
		.withCompatibleAttachment(AuxiliaryAttachments.M4Rail, true, (model) -> {
            if(model instanceof AKRail) {
            	...
            	GL11.glTranslatef(-0.22F, -1.6F, -4f);
                GL11.glScaled(0.7F, 0.7F, 0.85F);
            } else if(model instanceof AKRail5) {
                GL11.glTranslatef(-0.22F, -1.6F, -1.9f);
	   ...
	   .withCompatibleAttachment(Attachments.MBUSRearSights, (model) -> {
        ...
        .withCompatibleAttachment(Attachments.SIGTANGO6T, (player, stack) -> {
            GL11.glTranslatef(-0.16F, -1.53F, -1.7F);
            GL11.glScaled(0.5F, 0.5F, 0.45F);
        },(model) -> {
            if(model instanceof JPUreticle) {
                GL11.glTranslatef(0.076F, -0.67F, 4.0251F);
                GL11.glScaled(0.04F, 0.04F, 0.04F);
		...
		.withCompatibleAttachment(Attachments.Laser2, (p, s) -> {
		    GL11.glTranslatef(-0.26F, -1.43F, -3.15F);
		...
		.withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                ...
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.SIGTANGO6T)) {
                    GL11.glTranslatef(0.001F, 0.03f, -0.1f);
                }
